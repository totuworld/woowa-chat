...
const LeaderMettingGNB: React.FC = function () {
    ...
    <Menu>
      ...
      <MenuList>
        {isOwner && (
          <MenuItem
            onClick={() => {
              window.location.href = '/leader_meeting';
            }}
          >
            타운홀 목록
          </MenuItem>
      ...
      >
        ...
        <Flex flex={{ base: 2 }} justify={{ base: 'center', md: 'start' }}>
          <Link href="/leader_meeting">
            <img style={{ height: '40px', cursor: 'pointer' }} src="/logo_leaders.png" alt="logo" />
          </Link>
        </Flex>
...
export default LeaderMettingGNB;
