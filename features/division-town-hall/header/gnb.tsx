...
const DivMeetingGNB: React.FC = function () {
    ...
    <Menu>
      ...
      <MenuList>
        {isOwner && (
          <MenuItem
            onClick={() => {
              window.location.href = '/division-town-hall';
            }}
          >
            타운홀 목록
          </MenuItem>
        ...
        {isOwner && (
          <MenuItem
            onClick={() => {
              window.location.href = '/division-town-hall/owner-members';
            }}
          >
            관리자 추가/삭제
          </MenuItem>
