...
async function create({
  ...
  const url = '/api/division-town-hall/create';
  try {
    const postData = {
      title,
      createId,
...
async function get({
  ...
  const url = `${hostAndPort}/api/division-town-hall/info/${instantEventId}`;
  try {
...
async function lock({ instantEventId }: { instantEventId: string }): Promise<Resp<unknown>> {
  const url = '/api/division-town-hall/lock';
  try {
...
async function showMsgAndCollectReply({ instantEventId }: { instantEventId: string }): Promise<Resp<unknown>> {
  const url = '/api/division-town-hall/show-msg-collect-reply';
  try {
    const resp = await requester({
      option: {
        url,
...
async function publish({ instantEventId }: { instantEventId: string }): Promise<Resp<unknown>> {
  const url = '/api/division-town-hall/publish';
  try {
    const resp = await requester({
      option: {
        url,
...
async function unpublish({ instantEventId }: { instantEventId: string }): Promise<Resp<unknown>> {
  const url = '/api/division-town-hall/unpublish';
  try {
    const resp = await requester({
      option: {
        url,
...
async function close({ instantEventId }: { instantEventId: string }): Promise<Resp<unknown>> {
  const url = '/api/division-town-hall/close';
  try {
    const resp = await requester({
      option: {
        url,
...
async function reopen({ instantEventId }: { instantEventId: string }): Promise<Resp<unknown>> {
  const url = '/api/division-town-hall/reopen';
  try {
    const resp = await requester({
      option: {
        url,
...
async function immediateClosSendMessagePeriod({ instantEventId }: { instantEventId: string }): Promise<Resp<unknown>> {
  const url = '/api/division-town-hall/close-send-message';
  try {
    const resp = await requester({
      option: {
        url,
...
async function post({
  ...
  const url = '/api/division-town-hall/messages.add';
...
async function postReply({
  ...
  const url = `/api/division-town-hall/messages.add.reply/${instantEventId}/${messageId}`;
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
    const sendData: {
      reply: string;
...
async function getMessageInfo({
  ...
  const url = `/api/division-town-hall/messages.info/${instantEventId}/${messageId}`;
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
...
async function denyMessage({
  ...
  const url = '/api/division-town-hall/messages.deny';
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
...
async function deleteMessage({
  ...
  const url = '/api/division-town-hall/messages.delete';
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
    await requester<InInstantEventMessage>({
      option: {
...
async function updateMessageSortWeight({
  ...
  const url = '/api/division-town-hall/messages.sort_weight';
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
    await requester<InInstantEventMessage>({
      option: {
...
async function updateMessage({
  ...
  const url = '/api/division-town-hall/messages.update_body';
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
    await requester<InInstantEventMessage>({
      option: {
...
async function updateReply({
  ...
  const url = '/api/division-town-hall/messages.update_reply';
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
    await requester<InInstantEventMessage>({
      option: {
...
async function denyReply({
  ...
  const url = '/api/division-town-hall/messages.deny_reply';
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
    await requester<InInstantEventMessage>({
      option: {
...
async function deleteReply({
  ...
  const url = '/api/division-town-hall/messages.delete_reply';
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
    await requester<InInstantEventMessage>({
      option: {
...
async function pinMessage({
  ...
  const url = '/api/division-town-hall/messages.pin';
  const token = await FirebaseAuthClient.getInstance().Auth.currentUser?.getIdToken();
  try {
    await requester<InInstantEventMessage>({
      option: {
