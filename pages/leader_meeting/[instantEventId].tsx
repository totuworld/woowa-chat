...
import InstantInfo from '@/features/leader_meeting/header/instant_info.component';
import FirebaseAuthClient from '@/models/auth/firebase_auth_client';
import { useAuth } from '@/contexts/auth_user.context';
import InstantEventHeaderSideMenu from '@/features/leader_meeting/header/side_menu.component';
import ChatClientService from '@/features/leader_meeting/chat.client.service';
import ColorPalette from '@/styles/color_palette';
import InstantEventUtil from '@/features/leader_meeting/instant_event.util';
import CreateEvent from '@/features/leader_meeting/create_event.component';
import MessageList from '@/features/leader_meeting/message_list';
import GoogleLoginButton from '@/components/google_login_button';
import Presentation from '@/features/leader_meeting/presentation';
  ...
  const { status, refetch } = useQuery(
    ...
    async () => {
      ...
      const resp = await axios.get<{ list: InInstantEventMessage[]; uniqueVoterCount: number }>(
        `/api/leader_meeting/messages.list_with_voter_count/${instantEventInfo?.instantEventId}?isPreview=${isPreview}`,
        {
